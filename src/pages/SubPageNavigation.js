...
import { Segment, Grid, Container, Menu, Button, Dropdown } from 'semantic-ui-react'
            ...
            <Grid.Row>
              <Grid.Column>
                <Menu size="huge" stackable inverted pointing secondary>
                  ...
                  <Menu.Item link name="subpage-a" as={NavLink} to="/subpage-a" />
                  <Menu.Item link name="subpage-b" as={NavLink} to="/subpage-b" />
